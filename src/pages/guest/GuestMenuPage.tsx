...
export default function GuestMenuPage() {
  const { menuItems, menuItemsLoading, categories, cart, addToCart, updateCartQuantity, getCartItemCount, getCartTotal } = useApp();
      ...
      {cartItemCount > 0 && (
        <div className="fixed bottom-0 left-0 right-0 p-4 bg-background/95 backdrop-blur-sm border-t border-border lg:hidden">
          ...
          >
            ...
            Lihat Keranjang ({cartItemCount}) - Rp {getCartTotal().toLocaleString('id-ID')}
          </Button>
        </div>
      )}
    </div>
